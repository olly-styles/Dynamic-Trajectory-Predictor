...
def main():
    ...
    img_root = './data/optical-flow/jaad/'
    ...
    model_save_path = '/media/olly/models/jaad/'
    ...
    for fold in [1,2,3,4,5]:
        ...
        if pretrained:
            ...
            model.load_state_dict(torch.load(model_load_path + 'bdd10k_rn18_flow_css_'+ str(NUM_FLOW_FRAMES) + 'stack_training_proportion_100_shuffled_disp.weights'))
        ...
        np.save('./results/predictions_rn18_flow_css_'+ str(NUM_FLOW_FRAMES) + 'stack_jaad_fold_' + str(fold) + 'pretrained-' + str(pretrained) +'_disp.npy',all_outputs)
        np.save('./results/targets_rn18_flow_css_' + str(NUM_FLOW_FRAMES) + 'stack_jaad_fold_' + str(fold) + 'pretrained-' + str(pretrained) +'_disp.npy',all_targets)
        ...
        results.to_csv('./results/results_rn18_jaad.csv',index=False)
